...
module.exports = function(options, db) {
  ...
  function themeHandler(req, res) {
    ...
    gfs.files.findOne({
      ...
      if (!file) {
        fs.createReadStream(config.root + '/bower_components/bootstrap/dist/css/bootstrap.min.css').pipe(res);
      } else {
        // streaming to gridfs
  ...
  app.get('/bower_components/bootstrap/dist/css/bootstrap.min.css', themeHandler);
